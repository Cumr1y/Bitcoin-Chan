...
module.exports = {
    name: "info",
    description:
        "Obtén información sobre el bot y accede al servidor principal",
    dmPermission: true,
    testOnly: true,
    deleted: true,
    callback: async (client, interaction) => {
        const embed = new EmbedBuilder()
            ...
            .addFields(
                {
                    name: "Servidores para los que existo",
                    value: `${client.guilds.cache.size}`,
                    inline: true,
                },
                {
                    name: "Usuarios ayudados",
                    value: `${client.users.cache.size}`,
                    inline: true,
                },
                {
                    name: "Tiempo en línea",
                    value: `${Math.floor(client.uptime / 1000 / 60)} minutos`,
                    inline: true,
                },
            )
            .setFooter({
                text: "Sí, funciono mejor que la mitad de los bots del mercado (eso creo...)",
            })
